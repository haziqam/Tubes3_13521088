...
function getQnA() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/post/getQnA")];
                case 1:
                    res = _a.sent();
                    if (!res.ok) {
...
function addQnA(question, answer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/post/addQnA", {
                        method: 'POST',
...
function updateAnswer(id, newAnswer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/post/updateAnswer", {
                        method: 'PUT',
                        body: JSON.stringify({ param: {
                                id: id,
                                newAnswer: newAnswer
...
function deleteQnA(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/api/post/deleteQnA", {
                        method: 'PUT',
                        body: JSON.stringify({ param: {
                                id: id
                            }
